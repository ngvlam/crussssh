    ...
    Swal.fire({
        ...
        if (result.value) {
            Swal.fire({
                ...
                text: "Tối nay tớ qua đón cậu đi chơi nhaaaaaaaaa :v Còn giờ thì chờ gì nữa mà không inbox cho tớ đi nàoooooo",
                confirmButtonColor: '#83d0c9',
                onClose: () => {
                    window.location = 'https://www.facebook.com/nguyenlam2102/';
                  }
            })
        }
    })
